...
static char* getTelemetryPayload()
{
 //TO DO - Get data from sensors and replace the 20
  ...
  (void)az_span_u32toa(temp_span, bme.humidity,&temp_span);  
    temp_span = az_span_copy(temp_span, AZ_SPAN_FROM_STR(","));
   temp_span = az_span_copy(temp_span, AZ_SPAN_FROM_STR(" \"lat\": "));
  (void)az_span_dtoa(temp_span, 47.647869,6, &temp_span);  
   temp_span = az_span_copy(temp_span, AZ_SPAN_FROM_STR(","));
   temp_span = az_span_copy(temp_span, AZ_SPAN_FROM_STR(" \"longitude\": "));

(void)az_span_dtoa(temp_span, -121.914299,6, &temp_span);  
